...
/* Generation options: */
#ifndef __model_start_h__
#define __model_start_h__
...
/* Class declaration for a model of start */
class MODEL_start : public Model {
 
 /* Top-level module instance */
 private:
  MOD_start *start_instance;
...
#endif /* ifndef __model_start_h__ */
